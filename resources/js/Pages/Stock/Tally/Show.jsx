...
import { ArrowLeft, BookOpenCheck, Printer } from 'lucide-react';
                    ...
                    <table className="w-full border-collapse text-sm">
                        ...
                        <tbody className="[&>tr]:border-b [&>tr]:border-ncat-silver [&>tr>td]:px-2 [&>tr>td]:py-1.5">
                            {card ? (
                                ...
                                <tr><td colSpan={8} className="py-8 text-center text-muted-foreground">No movements for this part in any store yet.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>

...
export const navItems = [
    ...
    { label: 'Stores', icon: Warehouse, routeName: 'stores', group: 'operations', permission: 'stores.view' },
    ...
    { label: 'Parts', icon: Boxes, routeName: 'parts', group: 'catalogue', permission: 'parts.view' },
